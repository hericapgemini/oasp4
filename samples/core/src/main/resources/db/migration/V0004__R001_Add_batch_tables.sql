...
CREATE TABLE BATCH_JOB_EXECUTION  (
  ...
  CREATE_TIME BINARY(8) NOT NULL,
  START_TIME BINARY(8) DEFAULT NULL ,
  END_TIME BINARY(8) DEFAULT NULL ,
  STATUS VARCHAR(10) ,
  EXIT_CODE VARCHAR(2500) ,
  EXIT_MESSAGE VARCHAR(2500) ,
  LAST_UPDATED BINARY(8),
...
CREATE TABLE BATCH_JOB_EXECUTION_PARAMS  (
  ...
  DATE_VAL BINARY(8) DEFAULT NULL ,
  LONG_VAL BIGINT ,
...
-- CALL CreateSequence('BATCH_STEP_EXECUTION_SEQ', 1, 1);
--CALL CreateSequence('BATCH_JOB_EXECUTION_SEQ', 1, 1);
---CALL CreateSequence('BATCH_JOB_SEQ', 1, 1);
